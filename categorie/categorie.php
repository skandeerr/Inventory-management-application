...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <form class="d-flex w-100" action="categorie.php" method="POST">
...
<div class="container">
  <div class="row row-cols-3 col-sm-12 col-xs-12"> 
<?php  foreach($categories as $categorie){
    print '<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3"><div class="card" style="width: 18rem;">
    <img src="img/'.$categorie['photo'].'" height="200px" width="100px"  class="card-img-top" alt="...">
    <div class="card-body">
      <h5 style="font-size: 0.9rem" class="card-title">'.$categorie['nom'].'</h5>
      <a style="font-size: 0.9rem" href="../produit/produit.php?idc='.$categorie['id'].'" class="btn btn-outline-primary">Produits</a>
      <a style="font-size: 0.9rem" onclick="return popUpDeleteCategorie()" href="supprimer.php?idc='.$categorie['id'].'" class="btn btn-outline-danger ml-2">Supprimer</a>
      </div>
  </div></div>';
}?>
</div>
